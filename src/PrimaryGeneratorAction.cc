  ...
  : G4VUserPrimaryGeneratorAction(), fParticleGun(0)
{
  ...
  fParticleGun->SetParticleEnergy(0.000000000005*eV);
...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  //uniformly in a cube with edge at given x,y plane centered in z
  //G4UniformRand gives values 0-1
  x0 = xp + G4UniformRand() - 0.5;
  y0 = yp + G4UniformRand();
  z0 = zp + G4UniformRand()-0.5;
  ...
  std::cout << "generated primary vertex" << std::endl;
